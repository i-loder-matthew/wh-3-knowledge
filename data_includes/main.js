...
PennController.Sequence("consent", "instructions", "practice-message", "practice1", "practice2", "experiment-message", rshuffle(rshuffle("partial-info" , "no-info"), rshuffle("partial-knowledge", "no-knowledge")), "questionnaire")
